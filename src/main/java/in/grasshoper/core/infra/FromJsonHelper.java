...
public class FromJsonHelper {
    ...
    public BigDecimal extractBigDecimalNamedWithLocaleEN(final String parameterName, final JsonElement element) {
        return this.helperDelegator.extractBigDecimalNamed(parameterName, element.getAsJsonObject(), Locale.ENGLISH, new HashSet<String>());
    }
    ...
    public JsonObject extractJsonObjectOfParameterNamed(String parameterName, JsonElement element) {
        JsonObject jsonObject = null;
        final JsonObject topLevelJsonElement = element.getAsJsonObject();
        if (topLevelJsonElement.has(parameterName) && topLevelJsonElement.get(parameterName).isJsonObject()) {
            jsonObject = topLevelJsonElement.get(parameterName).getAsJsonObject();
        }
        return jsonObject;
    }
