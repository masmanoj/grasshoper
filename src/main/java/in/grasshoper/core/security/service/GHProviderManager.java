 ...
 * the <code>NovobankProviderManager</code> will throw a <code>ProviderNotFoundException</code>.
 ...
 */
public class GHProviderManager implements AuthenticationManager, MessageSourceAware, InitializingBean {
    //~ Static fields/initializers =====================================================================================

    private static final Log logger = LogFactory.getLog(GHProviderManager.class);
     ...
     */
    @Deprecated
    public GHProviderManager() {
   
    }

    public GHProviderManager(List<AuthenticationProvider> providers) {
        this(providers, null);
    }

    public GHProviderManager(List<AuthenticationProvider> providers, AuthenticationManager parent) {
    ...
    public Authentication authenticate(final Authentication authentication) throws AuthenticationException {
        ...
        if (lastException == null) {
            lastException = new ProviderNotFoundException(messages.getMessage("NovobankProviderManager.providerNotFound",
