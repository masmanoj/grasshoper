...
function loadCartData() {
    ...
    if (data == "" || data == null) {
        ...
        data.forEach(function(val) {
            ...
            product = "";
            product += "<span class='' title='remove item'><a onclick='removeFromCart(&#34;" + items[0] + "&#34;)'><i class='fa fa-trash-o'></i></a></span> " + items[1] + "<span class='label label-warning pull-right'>" + items[2]*items[3] + "</span>";
